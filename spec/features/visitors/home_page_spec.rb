...
feature "Home page" do
  ...
  before(:all) do
    ...
    games = []
    Timecop.scale(3600)
    games << @game0 = FactoryBot.create(:edition, release_date: nil)
    games << @gameFuture = FactoryBot.create(:edition, release_date: 5.days.from_now)
    games << @game1 = FactoryBot.create(:edition, release_date: Date.new(2016, 5, 12))
    games << @game2 = FactoryBot.create(:edition, release_date: Date.new(2015, 5, 12))
    games << @game3 = FactoryBot.create(:edition, release_date: Date.new(2014, 5, 12))
    games << @game4 = FactoryBot.create(:edition, release_date: Date.new(2013, 5, 12))
    games << @game5 = FactoryBot.create(:edition, release_date: Date.new(2012, 5, 12))
    games << @game6 = FactoryBot.create(:edition, release_date: Date.new(2011, 5, 12))
    games << @game7 = FactoryBot.create(:edition, release_date: Date.new(2010, 5, 12))
    games << @game8 = FactoryBot.create(:edition, release_date: Date.new(2009, 5, 12))
    games << @game9 = FactoryBot.create(:edition, work: @game8.work, release_date: Date.new(2008, 5, 12))
    @expansion1 = FactoryBot.create(:expansion, edition: @game9, release_date: Date.new(2008, 8, 12))
    Timecop.return
